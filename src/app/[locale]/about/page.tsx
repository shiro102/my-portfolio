      ...
      <div className="min-h-screen lg:flex relative" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0">
          ...
          <div className="flex flex-col gap-12 justify-center">
            {/* BIOGRAPHY IMAGE */}
            <Image
              src="https://drive.google.com/thumbnail?id=1X7d1TV0N68MAEhTxzgjnEMyFlEg5MrO3&sz=w1000"
              alt=""
              width={112}
              height={112}
            ...
            />
            {/* BIOGRAPHY TITLE */}
            <h1 className="text-2xl font-[--font-tai-heritage-pro]">{t("bio-title")}</h1>
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">{t("bio-desc")}</p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">{t("bio-quote")}</span>
            {/* BIOGRAPHY SIGN SVG*/}
            <div className="self-end">
              <Image
                src="/assets/FixedSignature.png"
                alt="signature"
                width={185}
                height={77}
                className="dark:invert dark:brightness-0 grayscale"
              />
            </div>
          ...
          <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
            ...
            <motion.h1
              ...
              className="font-bold text-2xl font-[--font-tai-heritage-pro]"
            >
              {t("about-skill")}
            </motion.h1>
            {/* SKILL LIST */}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg text-black">
                    {t("experience-jobtitle1")}
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    {t("experience-jobdesc1")}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg text-black">
                    {t("experience-jobtitle2")}
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                  {t("experience-jobdesc2")}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    May, 2023 - Nov, 2024
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg text-black">
                    {t("experience-jobtitle3")}
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    {t("experience-jobdesc3")}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    May, 2022 - Apr, 2023
